*UPDATE: This package is rendered obsolete in Emacs 28.1.*\\
Set =xref-file-name-display= to =project-relative= to achieve the [[https://git.savannah.gnu.org/cgit/emacs.git/commit/etc/NEWS?id=13b59c690ada05f670d8056a6710045b22097c88][same
effect]].
